...
function giftSummary(id,compact=false){const g=gifts[id];return `<div class="gift-icon">${g.icon}</div><div><strong>${g.title}</strong><span>${compact?'Selected gift':g.description}</span></div>`}
